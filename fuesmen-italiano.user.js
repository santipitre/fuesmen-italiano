...
(function () {
  ...
  function buildHTML(P){
    ...
    +'var COLS=["#","N° Pedido","Doc","Documento","Paciente","Tipo","Ubicación","Servicio","O.S.","Aseguradora","Cuenta","Prestador","Fecha y hora","Estado turno","Turno N°","Turno Fecha","Turno Estudio","Estudios solicitados","Diagnóstico","Observación"];'
